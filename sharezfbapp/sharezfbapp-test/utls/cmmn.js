...
function getAddressByLocation(latitude, longitude, distince, funSuccess, funError) {
  var key = "DCLBZ-LSM3F-DBWJF-NXDGT-JLUQO-7RBYX";//固定的lxy申请的，是企业号..
  var url = "https://apis.map.qq.com/ws/place/v1/search?boundary=nearby(" + latitude + "," + longitude + "," + distince + ")";
  var key1 = "VDUBZ-AKZRQ-7U257-GOGBW-23FS6-6FBLW"
  var key2 = "N2GBZ-3CV3U-MREV6-BLZ3D-UN6C7-YPFOJ"//"DCLBZ-LSM3F-DBWJF-NXDGT-JLUQO-7RBYX"
  var key3 = "N2GBZ-3CV3U-MREV6-BLZ3D-UN6C7-YPFOJ"
...
function getLocationByAddress(address, funSuccess, funError) {
  ...
  var key1 = "VDUBZ-AKZRQ-7U257-GOGBW-23FS6-6FBLW"
  var key2 = "DCLBZ-LSM3F-DBWJF-NXDGT-JLUQO-7RBYX"
  var key3 = "N2GBZ-3CV3U-MREV6-BLZ3D-UN6C7-YPFOJ"
  var minutes = new Date().getMinutes();
  if (minutes % 4 == 1) {
    key = key1
