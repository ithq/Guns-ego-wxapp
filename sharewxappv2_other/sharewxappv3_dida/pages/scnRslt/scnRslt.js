...
Page({
  ...
  onLoad: function (options) {
    ...
    app.showInterstitial(that, 'adunit-89733e3e6be3bb46');
  },
  ...
  myWantToCharge: function(e) {
    let that = this;
    let feeTypeByTime = e.currentTarget.dataset.id;
    console.log("feeTypeByTime=" + feeTypeByTime)
    that.setData({
      selectFeeTypeByTime: feeTypeByTime
    })
    that.myWantToReCharge();
  },
  /**
