...
App({
  ...
  glbParam: {
    ...
    baseUrl: "https://api.bonvan.xin/rest",
    serverUrl: "https://api.bonvan.xin",
    serveiceTelNo: "400-852-85-82",//服务电话
  ...
  clickAdvertInfo: function(type, businessId){
    ...
    if(advertInfo){
      if(advertInfo.navigateTo == "url"){
        // 广告点击
        wx.navigateTo({
          url: '/pages/webView/webView?url=' + advertInfo.url
        });
