...
App({
  ...
  glbParam: {
    ...
    baseUrl: "https://api.shandianba.cn/rest",
    serverUrl: "https://api.shandianba.cn",
    serveiceTelNo: "18565664203"//服务电话
  },
  //onLaunch...
  ...
  isLogined: function (mustAlt) {
    if (this.glbParam.ssn_3rd == null || this.glbParam.ssn_3rd == undefined ||
      ...
      if (mustAlt) {
        try {
          utl.altDialog("提示", "正在登录中...请稍后!", "确定", null);
        } catch (res) {
        }
      }
      return false;
