...
// var rqstBaseUrl = "https://it.frp.szego.net/rest/" 
// var rqstBaseUrl = "https://ewx.szego168.com/rest/"
var rqstBaseUrl = "https://api.jiekeba.cn/rest/" 
 ...
 * 防止重复点击
 * @param {obj} fn object
 * @param {int} gapTime ms
 */
function throttle(object, gapTime) {
  if (gapTime == null || gapTime == undefined) {
      gapTime = 1500
  }
  let _lastTime = null
  let _nowTime = + new Date()
  if (_nowTime - object._lastTime > gapTime || !object._lastTime) {
    object._lastTime = _nowTime
    return true;
  }
  return false;
}
