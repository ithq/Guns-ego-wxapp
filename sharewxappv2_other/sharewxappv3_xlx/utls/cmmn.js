...
function getAddressByLocation(latitude, longitude, distince, funSuccess, funError) {
  var key = "FSYBZ-YSI36-P5WSE-EZJ4U-7RMNJ-XIFGE";//固定的地图，是企业号..
  var url = "https://apis.map.qq.com/ws/place/v1/search?boundary=nearby(" + latitude + "," + longitude + "," + distince + ")";
  var key1 = "MJPBZ-YMLWX-33T46-7ZQJA-BQUFV-TWFNU"
  var key2 = "KNQBZ-AJV34-B25UF-DOEQU-K5HXT-P2BJH"
  var key3 = "YRNBZ-K4ZWF-JM7JO-NWOWI-NMP2T-D2FLB"
...
function getLocationByAddress(address, funSuccess, funError) {
  var key = "FSYBZ-YSI36-P5WSE-EZJ4U-7RMNJ-XIFGE"//是企业号KEY..
